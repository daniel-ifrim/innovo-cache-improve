 ...
 */
namespace Innovo\CacheImprove\Plugin\Observer\PageCache;

use Magento\Framework\Event\Observer as EventObserver;

/**
 * Class PageCache FlushCacheByTags Plugin
 */
class FlushCacheByTags
{
     ...
     *
     * @param \Magento\PageCache\Observer\FlushCacheByTags $subject
     * @param EventObserver $observer
     * @return array
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     */
    public function beforeExecute(
        \Magento\PageCache\Observer\FlushCacheByTags $subject,
