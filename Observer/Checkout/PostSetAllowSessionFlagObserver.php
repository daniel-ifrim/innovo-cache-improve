...
/**
 * Class PostSetAllowSessionFlagObserver
 * Set session checkout allow flag on all checkout configured actions.
 */
class PostSetAllowSessionFlagObserver implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        try {
            ...
            $allowed = $this->paymentHelper->getFullActionNamesPostDispatch();
